...
import (
	...
	"github.com/ernestzhang/outline-go-tun2socks/outline"
)
...
func ConnectShadowsocksTunnel(tunWriter TunWriter, host string, port int, password, cipher string, isUDPEnabled bool , tk string) (OutlineTunnel, error) {
	if tunWriter == nil {
	...
	return outline.NewTunnel(host, port, password, cipher, isUDPEnabled, tunWriter , tk)
}
